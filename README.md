...
- **Formula Engine**: Built-in lightweight AST parser and evaluation engine (`XLFormulaEngine`) supporting 75+ standard Excel functions (Math, Logic, Text, Statistical, Financial, etc.) without requiring external Excel calculation.
