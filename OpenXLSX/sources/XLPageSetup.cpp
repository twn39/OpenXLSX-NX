...
{
    setAttr(m_node, "left", std::to_string(value));
    return *this;
}
...
{
    setAttr(m_node, "right", std::to_string(value));
    return *this;
}
...
{
    setAttr(m_node, "top", std::to_string(value));
    return *this;
}
...
{
    setAttr(m_node, "bottom", std::to_string(value));
    return *this;
}
...
{
    setAttr(m_node, "header", std::to_string(value));
    return *this;
}
...
{
    setAttr(m_node, "footer", std::to_string(value));
    return *this;
}
...
void XLPrintOptions::setGridLines(bool value) { setAttr(m_node, "gridLines", value ? "1" : "0"); }

bool XLPrintOptions::headings() const { return m_node.attribute("headings").as_bool(); }
void XLPrintOptions::setHeadings(bool value) { setAttr(m_node, "headings", value ? "1" : "0"); }

bool XLPrintOptions::horizontalCentered() const { return m_node.attribute("horizontalCentered").as_bool(); }
void XLPrintOptions::setHorizontalCentered(bool value) { setAttr(m_node, "horizontalCentered", value ? "1" : "0"); }

bool XLPrintOptions::verticalCentered() const { return m_node.attribute("verticalCentered").as_bool(); }
void XLPrintOptions::setVerticalCentered(bool value) { setAttr(m_node, "verticalCentered", value ? "1" : "0"); }
...
{
    setAttr(m_node, "paperSize", std::to_string(value));
    ;
    return *this;
}
...
XLPageSetup& XLPageSetup::setOrientation(XLPageOrientation value)
{
    if (value == XLPageOrientation::Portrait)
        setAttr(m_node, "orientation", "portrait");
    else if (value == XLPageOrientation::Landscape)
        setAttr(m_node, "orientation", "landscape");
    else
...
{
    setAttr(m_node, "scale", std::to_string(value));
    ;
    return *this;
}
...
{
    setAttr(m_node, "fitToWidth", std::to_string(value));
    ;
    return *this;
}
...
{
    setAttr(m_node, "fitToHeight", std::to_string(value));
    ;
    return *this;
}
...
{
    setAttr(m_node, "pageOrder", std::string(value));
    ;
    return *this;
}
...
{
    setAttr(m_node, "useFirstPageNumber", value ? "1" : "0");
    ;
    return *this;
}
...
{
    setAttr(m_node, "firstPageNumber", std::to_string(value));
    ;
    return *this;
}
...
{
    setAttr(m_node, "blackAndWhite", value ? "1" : "0");
    ;
    return *this;
}
...
void XLHeaderFooter::setDifferentFirst(bool value) { setAttr(m_node, "differentFirst", value ? "1" : "0"); }

bool XLHeaderFooter::differentOddEven() const { return m_node.attribute("differentOddEven").as_bool(false); }
void XLHeaderFooter::setDifferentOddEven(bool value) { setAttr(m_node, "differentOddEven", value ? "1" : "0"); }

bool XLHeaderFooter::scaleWithDoc() const { return m_node.attribute("scaleWithDoc").as_bool(true); }
void XLHeaderFooter::setScaleWithDoc(bool value) { setAttr(m_node, "scaleWithDoc", value ? "1" : "0"); }

bool XLHeaderFooter::alignWithMargins() const { return m_node.attribute("alignWithMargins").as_bool(true); }
void XLHeaderFooter::setAlignWithMargins(bool value) { setAttr(m_node, "alignWithMargins", value ? "1" : "0"); }
...
{
    setChildText(m_node, "oddHeader", value, XLHeaderFooterNodeOrder);
}
...
{
    setChildText(m_node, "oddFooter", value, XLHeaderFooterNodeOrder);
}
...
{
    setChildText(m_node, "evenHeader", value, XLHeaderFooterNodeOrder);
}
...
{
    setChildText(m_node, "evenFooter", value, XLHeaderFooterNodeOrder);
}
...
{
    setChildText(m_node, "firstHeader", value, XLHeaderFooterNodeOrder);
}
...
{
    setChildText(m_node, "firstFooter", value, XLHeaderFooterNodeOrder);
}
